...
if csv_amperage:
	...
	savefig(r'out\csv_amperage\dataIoff_block.png', orientation='landscape', papertype='a4', format='png')
	print()
	print(parametr_1[0])
	print(parametr_3[0])
	print()
	...
	savefig(r'out\csv_amperage\dataIoff_model1.png', orientation='landscape', papertype='a4', format='png')
	print()
	print(parametr_1[0])
	print(parametr_3[0])
	...
	savefig(r'out\csv_amperage\begin_camp.png', orientation='landscape', papertype='a4', format='png')
...
if csv_half_sum:
	...
	dataIoff_block = pd.read_csv(r'data\dataIoff_block.csv', sep="\t", index_col = False)
	plt.rcParams.update({'font.size': 14})
	parametr_1, parametr_cov_1 = curve_fit(approk, np.array(dataIoff_block['offset_block']), np.array(dataIoff_block['I1block'])/2 + np.array(dataIoff_block['I3block'])/2)
	...
	ax1 = fig.add_subplot(111)
	ax1.grid(True)
	ax1.plot(np.array(dataIoff_block['offset_block']), np.array(dataIoff_block['I1block'])/2 + np.array(dataIoff_block['I3block'])/2, 'ro', np.array(dataIoff_block['offset_block']), func_11, 'k')
	
	ax1.set_xlabel(u'offset_block, %')
	ax1.set_ylabel(u'$(I1+I3)/2$')
	ax1.legend((u'(I1block + I3block)/2', u'func_11'), loc='best')
	ax1.set_title(u'dataIoff_block.csv') 
	#ax1.set_xlim((dat["time"][0], dat["time"][-1]))
	#ax1.set_ylim((ylim_min, ylim_max)) 

	savefig(r'out\csv_half_sum\dataIoff_block.png', orientation='landscape', papertype='a4', format='png')
	print()
	print(parametr_1[0])
	...
	dataIoff_model1 = pd.read_csv(r'data\dataIoff_model1.csv', sep="\t", index_col = False)
	plt.rcParams.update({'font.size': 14})
	parametr_1, parametr_1_cov = curve_fit(approk, np.array(dataIoff_model1['offset_model1']), np.array(dataIoff_model1['I1model_1'])/2 + np.array(dataIoff_model1['I3model_1'])/2)
	...
	ax1 = fig.add_subplot(111)
	ax1.grid(True)
	ax1.plot(np.array(dataIoff_model1['offset_model1']), np.array(dataIoff_model1['I1model_1'])/2 + np.array(dataIoff_model1['I3model_1'])/2, 'ro', np.array(dataIoff_model1['offset_model1']), func_12, 'k')
	
	ax1.set_xlabel(u'offset_block, %')
	ax1.set_ylabel(u'$I$')
	ax1.legend((u'(I1model_1 + I3model_1)/2', u'func_12'), loc='best')
	ax1.set_title(u'dataIoff_model1.csv') 
	#ax1.set_xlim((dat["time"][0], dat["time"][-1]))
	#ax1.set_ylim((ylim_min, ylim_max)) 

	savefig(r'out\csv_half_sum\dataIoff_model1.png', orientation='landscape', papertype='a4', format='png')
	print()
	print(parametr_1[0])
	...
	YQ_i_AKNP_chan_11 = np.array(data_begin_camp['YQ_i_AKNP_chan_11'])/YQ_i_AKNP_chan_11_cp
	YQ_i_AKNP_chan_13 = np.array(data_begin_camp['YQ_i_AKNP_chan_13'])/YQ_i_AKNP_chan_13_cp
	parametr_1, parametr_cov_1 = curve_fit(approk, np.array(data_begin_camp['offset_svrk']), YQ_i_AKNP_chan_11/2 + YQ_i_AKNP_chan_13/2)
	...
	ax1.grid(True)
	ax1.plot(np.array(dataIoff_block['offset_block']), np.array(dataIoff_block['I1block'])/2 + np.array(dataIoff_block['I3block'])/2, 'ro', np.array(dataIoff_block['offset_block']), func_11, 'k', 
			 np.array(dataIoff_model1['offset_model1']), np.array(dataIoff_model1['I1model_1'])/2 + np.array(dataIoff_model1['I3model_1'])/2, 'co', np.array(dataIoff_model1['offset_model1']), func_12, 'k',
			 np.array(data_begin_camp['offset_svrk']) - 4.5, YQ_i_AKNP_chan_11/2 + YQ_i_AKNP_chan_13/2, 'yo', np.array(data_begin_camp['offset_svrk']) - 4.5, func_13, 'k') 
	ax1.set_xlabel(u'offset, %')
	ax1.set_ylabel(u'$I$')
	ax1.legend((u'(I1block + I3block)/2', u'func_11', u'(I1model_1 + I3model_1)/2', u'func_12', u'(YQ_i_AKNP_chan_11 + YQ_i_AKNP_chan_13)/2', u'func_13'), loc='best')
	ax1.set_title(u'all') 
	#ax1.set_xlim((dat["time"][0], dat["time"][-1]))
	#ax1.set_ylim((ylim_min, ylim_max)) 
	...
	ax1 = fig.add_subplot(111)
	ax1.grid(True)
	ax1.plot(np.array(data_begin_camp['offset_svrk']), YQ_i_AKNP_chan_11/2 + YQ_i_AKNP_chan_13/2, 'ro', np.array(data_begin_camp['offset_svrk']), func_13, 'k')
	ax1.set_xlabel(u'offset_svrk, %')
	ax1.set_ylabel(u'$I$')
	ax1.legend((u'(YQ_i_AKNP_chan_11 + YQ_i_AKNP_chan_13)/2', u'func_13'), loc='best')
	ax1.set_title(u'begin_camp.csv') 
	#ax1.set_xlim((dat["time"][0], dat["time"][-1]))
	#ax1.set_ylim((ylim_min, ylim_max)) 

	savefig(r'out\csv_half_sum\begin_camp.png', orientation='landscape', papertype='a4', format='png')
